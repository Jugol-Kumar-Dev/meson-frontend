            ...
            <div class="flex gap-4 justify-between">
              ...
              <div class="flex gap-7 items-center">
                <!--                        <span class="flex items-center gap-1 text-sm font-medium text-primary-500">
                                            <svg class="hidden md:block" width="15" height="14" viewBox="0 0 15 14" fill="none"
                                                 xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_9494_69309)"><path
                                                ...
                                                fill="#6B7280"></path></g><defs><clipPath id="clip0_9494_69309"><rect width="14"
                                                                                                                      height="14"
                                                                                                                      fill="white"
                                                                                                                      transform="translate(0.291992)"></rect></clipPath></defs></svg>
                                            EN</span>-->
