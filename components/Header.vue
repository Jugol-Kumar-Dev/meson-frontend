                ...
                <div class="flex gap-4">
                    ...
                    <div class="flex items-center">
                        ...
                        <input type="text" id="table-search-users"
                            class="block p-2 ps-2 text-sm rounded text-primary-500 w-64 bg-white placeholder-slate-500 focus:ring-0 focus:border-white focus:outline-0"
                            placeholder="Skill Course or School Program">
                    </div>
                </div>
            </div>
            ...
            <div class="w-full lg:w-4/6">
                <div class="flex gap-4 justify-between">
                    ...
                    <div class="flex gap-7 items-center">
                        ...
                        <NuxtLink to="/login" class="rounded bg-primary-500 text-center text-white text-sm font-medium px-6 py-1">
                            Login
                        </NuxtLink>
                    </div>
                </div>
