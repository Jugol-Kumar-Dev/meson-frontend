<template xmlns="http://www.w3.org/1999/html">
    <button :disabled="isLoading" :class="isLoading ? 'animate-pulse' : ''" class=" my-3 bg-primary-700 w-full text-white rounded-md px-3 py-2  hover:bg-primary-600 transition-all disabled:bg-primary-700/50 ease-in-out duration-500">
        <span v-if="!isLoading">
            <slot></slot>
        </span>
        <span v-else class="flex justify-center gap-4 items-center">
