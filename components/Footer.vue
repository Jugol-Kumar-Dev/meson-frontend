...
<template>
    <footer>
        <Container>
                ...
                <div class="w-full lg:w-1/3">
                    <div class="text-center lg:text-left">
                        ...
                        <div class="flex justify-center lg:justify-start gap-4 py-3">
                            <img class="w-28 lg:w-40 h-12 lg:h-auto p-1" src="https://cdn.10minuteschool.com/images/google-play-icon_1695731678094.png?w=156&h=49" alt="" />
                            <img class="w-28 lg:w-40 h-12 lg:h-auto p-1" src="https://cdn.10minuteschool.com/images/ios-store-icon_1695731704002.png?w=156&h=49" alt="" />
                        </div>
                    </div>
                </div>
                <div class="w-full lg:w-1/3">
            ...
            <div class="flex items-center justify-center text-sm lg:text-base text-gray-600 py-4">
                <p class="text-center">2024 Copyright © Meson School. All rights reserved.</p>
            </div>  
        </Container>
    </footer>
</template>